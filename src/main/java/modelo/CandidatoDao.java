...
public class CandidatoDao {
    	private static final String  SQL_SELECT =  "SELECT id, nombre, direccion, telefono, fecha_nacimiento , fotografia, DNI FROM candidatos";
	private static final String  SQL_INSERT =  "INSERT  INTO clientes (nombre, direccion, telefono, fecha_nacimiento , fotografia, DNI) VALUES(?, ? , ? , ?, ?,?)";
		...
		try {
			...
			while (rs.next()) {
				...
				candidato = new Candidato(id, nombre, direccion, telefono, fechaNacimiento , fotografia, DNI);
		...
		try {
			...
			stmt.setString(5, candidato.getFoto());
