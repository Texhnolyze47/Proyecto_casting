...
public class CastingDao {
    ...
    private static final String SQL_SELECT = "SELECT id, nombre, descripcion, fecha, precio FROM casting";
    private static final String SQL_INSERT = "INSERT  INTO casting ( nombre, descripcion, fecha, costo) VALUES(?, ? , ? , ? )";
    ...
    public Casting selecccionar() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                casting = new Casting(idCasting, nombre, descripcion, fechaContratacion, costo);
