...
public class SeleccionCandidatoGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SeleccionCandidatoGUI
     */
    public SeleccionCandidatoGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionCandidatoGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionCandidatoGUI().setVisible(true);
            }
        });
    }
