...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2022 a las 18:21:32
...
--
CREATE DATABASE IF NOT EXISTS `casting` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `casting`;
...
('root', '[{\"db\":\"casting\",\"table\":\"casting-prueba\"},{\"db\":\"casting\",\"table\":\"cadidatos-perfil\"},{\"db\":\"casting\",\"table\":\"representate\"},{\"db\":\"casting\",\"table\":\"casting-agente\"},{\"db\":\"casting\",\"table\":\"casting-presencial\"},{\"db\":\"casting\",\"table\":\"casting-contratos\"},{\"db\":\"casting\",\"table\":\"clientes\"},{\"db\":\"casting\",\"table\":\"candidatos\"}]');
...
('root', '2022-03-11 16:17:18', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
